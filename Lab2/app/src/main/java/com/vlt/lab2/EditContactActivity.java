...
public class EditContactActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(v -> {
            ...
            resultIntent.putExtra("POSITION", pos); // Trả lại vị trí
